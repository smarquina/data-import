 ...
 * Generated for Laravel 7.15.0 on 2020-06-13 13:01:29.
 *
...
namespace App\Facades { 
    ...
    class FlashStatusFacade {
        ...
        {
            //Method inherited from \App\Http\Enums\Enum            
                        return \App\Http\Enums\FlashStatus::getKeys();
        }
        ...
        {
            //Method inherited from \App\Http\Enums\Enum            
                        return \App\Http\Enums\FlashStatus::getValues();
        }
        
        /**
         * Get all constants in enum
         *
         * @param string $name . Name of value
         * @return array 
         * @static 
         */ 
        public static function listConstants($name = 'name')
        {
            //Method inherited from \App\Http\Enums\Enum            
                        return \App\Http\Enums\FlashStatus::listConstants($name);
        }
...
namespace  { 
    ...
    class FlashStatus extends \App\Facades\FlashStatusFacade {}
